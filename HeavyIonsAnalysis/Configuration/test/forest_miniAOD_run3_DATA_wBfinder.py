...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        '/store/hidata/HIRun2023A/HIPhysicsRawPrime0/MINIAOD/PromptReco-v2/000/375/252/00000/0243dfd4-5239-4839-ba46-f91209bab768.root'
    ), 
)
...
process.Bfinder.tkPtCut = cms.double(2) # before fit
process.Bfinder.tkEtaCut = cms.double(10.) # before fit
