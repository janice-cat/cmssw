...
process.outputClusters = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:output/{:s}_approxClusterTrimmed.root'.format( os.path.basename(filename).strip('.root')) ),
...
process.TFileService = cms.Service("TFileService",
        fileName=cms.string("output/{:s}_approxClusterNtuple.root".format( os.path.basename(filename).strip('.root')) ))
