...
int main(int argc, char const *argv[])
{
	...
	static std::vector<int> bad_detIds_manual = {369121449,369121450,369124445,369124446,369124501,369124502,369141801,369141802,369142061,369142062,369142313,369142314,369142365,369142366,369154796,369158348,369174796,369174804,369174808,402666261,402666262,402668821,402668822,402677017,402677018,402677021,402677022,436232553,436232554,436249453,436249454,436282532,436294932,436295224,436314444,470045172,470065648,470116456,470127533,470127534,470143913,470143914,470161512,470180232,470181801,470181802,470311849,470311850,470344613,470344614,470372781,470372782,470377416,470395020,470410184};

	for (auto& _scs_perEvt_perDetId: r_dict[chooseEventId]) 
	{
		bool isBadDetId = std::find(bad_detIds_manual.begin(), bad_detIds_manual.end(), _scs_perEvt_perDetId.first) != bad_detIds_manual.end();
		if (isBadDetId) printf("isBadDetId %d\n", _scs_perEvt_perDetId.first);
		if (!isBadDetId) continue;
