...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(['file:'+f for f in glob.glob('/eos/cms/store/group/phys_heavyions/yuchenc/HITrackerNZS_hybridZS/hlt/HITrackerNZS/crab_HITrackerNZS/241024_102450/0000/outputPhysicsHIPhysicsRawPrime_46[0-5].root')]),
