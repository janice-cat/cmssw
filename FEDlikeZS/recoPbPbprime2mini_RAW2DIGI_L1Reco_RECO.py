...
# with command line options: recoPbPbprime2mini --conditions 141X_dataRun3_Prompt_v3 -s RAW2DIGI,L1Reco,RECO --datatier AOD --eventcontent AOD --data --process reRECO --scenario pp --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run3 --no_exec --era Run3_pp_on_PbPb_approxSiStripClusters_2024 --repacked
import glob as glob
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(['file:'+f for f in glob.glob('/eos/cms/store/group/phys_heavyions/yuchenc/HITrackerNZS_FEDlikeZS/hlt/HITrackerNZS/crab_HITrackerNZS/241024_094329/0000/outputPhysicsHIPhysicsRawPrime_46[0-5].root')]),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('recoPbPbprime2mini nevts:1'),
...
process.AODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('recoPbPbprime2mini_RAW2DIGI_L1Reco_RECO_2.root'),
