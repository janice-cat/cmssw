# hltGetConfiguration /users/soohwan/HLT_141X/TrackerZS/HLT_ZBMBRawPrime/V1 --process MYHLT --full --offline --data --type HIon --unprescale --globaltag 141X_dataRun3_HLT_v1 --max-events 1000 --output all

# /users/soohwan/HLT_141X/TrackerZS/HLT_ZBMBRawPrime/V1 (CMSSW_14_1_1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string("/users/soohwan/HLT_141X/TrackerZS/HLT_ZBMBRawPrime/V1")
)
...
process.streams = cms.PSet(  PhysicsHIPhysicsRawPrime = cms.vstring( 'HIPhysicsRawPrime' ) )
process.datasets = cms.PSet(  HIPhysicsRawPrime = cms.vstring( 'HLT_HIMinimumBiasHF1ANDZDC1nOR_v3',
  'HLT_HIMinimumBiasHF1ANDZDC2nOR_v6',
  'HLT_HIMinimumBiasHF1AND_v6',
  'HLT_HIZeroBias_v13' ) )
...
process.hltPreHIMinimumBiasHF1AND = cms.EDFilter( "HLTPrescaler",
    offset = cms.uint32( 0 ),
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" )
)
process.hltL1sZDC1nORMinimumBiasHF1ANDBptxAND = cms.EDFilter( "HLTL1TSeed",
    saveTags = cms.bool( True ),
    L1SeedsLogicalExpression = cms.string( "L1_ZDC1n_OR_MinimumBiasHF1_AND_BptxAND" ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
    L1GlobalInputTag = cms.InputTag( "hltGtStage2Digis" ),
    L1MuonInputTag = cms.InputTag( 'hltGtStage2Digis','Muon' ),
    L1MuonShowerInputTag = cms.InputTag( 'hltGtStage2Digis','MuonShower' ),
...
process.hltPreHIMinimumBiasHF1ANDZDC1nOR = cms.EDFilter( "HLTPrescaler",
    offset = cms.uint32( 0 ),
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" )
)
process.hltL1sZDC2nORMinimumBiasHF1ANDBptxAND = cms.EDFilter( "HLTL1TSeed",
    saveTags = cms.bool( True ),
    L1SeedsLogicalExpression = cms.string( "L1_ZDC2n_OR_MinimumBiasHF1_AND_BptxAND" ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
    L1GlobalInputTag = cms.InputTag( "hltGtStage2Digis" ),
    L1MuonInputTag = cms.InputTag( 'hltGtStage2Digis','Muon' ),
    L1MuonShowerInputTag = cms.InputTag( 'hltGtStage2Digis','MuonShower' ),
...
process.hltPreHIMinimumBiasHF1ANDZDC2nOR = cms.EDFilter( "HLTPrescaler",
    offset = cms.uint32( 0 ),
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" )
)
...
process.hltDatasetHIPhysicsRawPrime = cms.EDFilter( "TriggerResultsFilter",
    ...
    throw = cms.bool( True ),
    triggerConditions = cms.vstring( 'HLT_HIMinimumBiasHF1ANDZDC1nOR_v3',
      'HLT_HIMinimumBiasHF1ANDZDC2nOR_v6',
      'HLT_HIMinimumBiasHF1AND_v6',
      'HLT_HIZeroBias_v13' )
)
...
process.hltOutputPhysicsHIPhysicsRawPrime = cms.OutputModule( "PoolOutputModule",
    ...
    outputCommands = cms.untracked.vstring( 'drop *',
      ...
      "keep *_hltSiStripRawToDigi_*_*", 
      "keep *_hltSiStripZeroSuppression_*_*", 
      "keep *_hltSiStripDigiToZSRaw_*_*", 
...
process.HLT_HIZeroBias_v13 = cms.Path( process.HLTBeginSequence + process.hltL1ZeroBias + process.hltPreHIZeroBias + process.HLTDoHIStripZeroSuppressionAndRawPrime + process.HLTEndSequence )
process.HLT_HIMinimumBiasHF1AND_v6 = cms.Path( process.HLTBeginSequence + process.hltL1sMinimumBiasHF1ANDBptxAND + process.hltPreHIMinimumBiasHF1AND + process.HLTDoHIStripZeroSuppressionAndRawPrime + process.HLTEndSequence )
process.HLT_HIMinimumBiasHF1ANDZDC1nOR_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sZDC1nORMinimumBiasHF1ANDBptxAND + process.hltPreHIMinimumBiasHF1ANDZDC1nOR + process.HLTDoHIStripZeroSuppressionAndRawPrime + process.HLTEndSequence )
process.HLT_HIMinimumBiasHF1ANDZDC2nOR_v6 = cms.Path( process.HLTBeginSequence + process.hltL1sZDC2nORMinimumBiasHF1ANDBptxAND + process.hltPreHIMinimumBiasHF1ANDZDC2nOR + process.HLTDoHIStripZeroSuppressionAndRawPrime + process.HLTEndSequence )
...
process.PhysicsHIPhysicsRawPrimeOutput = cms.FinalPath( process.hltOutputPhysicsHIPhysicsRawPrime )


process.schedule = cms.Schedule( *(process.HLTriggerFirstPath, process.Status_OnCPU, process.Status_OnGPU, process.HLT_HIZeroBias_v13, process.HLT_HIMinimumBiasHF1AND_v6, process.HLT_HIMinimumBiasHF1ANDZDC1nOR_v3, process.HLT_HIMinimumBiasHF1ANDZDC2nOR_v6, process.HLTriggerFinalPath, process.HLTAnalyzerEndpath, process.Dataset_HIPhysicsRawPrime, process.PhysicsHIPhysicsRawPrimeOutput, ))
