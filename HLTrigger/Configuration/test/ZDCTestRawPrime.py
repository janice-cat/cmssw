# hltGetConfiguration adg:/cdaq/test/tomei/Run2023/ZDCTestRedux/HLT/V14 --input /store/hidata/HIRun2018/HITrackerVriginRaw/RAW/v1/000/325/813/00000/041AFBC1-FAF8-F240-BCEC-BEBE2FB67A32.root --globaltag 132X_dataRun3_HLT_v2 --unprescale

# /cdaq/test/tomei/Run2023/ZDCTestRedux/HLT/V14 (CMSSW_13_2_1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/test/tomei/Run2023/ZDCTestRedux/HLT/V14')
)
...
process.streams = cms.PSet( 
  ...
  Physics = cms.vstring( 'CommissioningZDC',
    'HLTPhysics' ),
  RawPrime = cms.vstring( 'CommissioningRawPrime' )
)
process.datasets = cms.PSet( 
  CommissioningRawPrime = cms.vstring( 'HLT_HIRawPrime_v1' ),
  CommissioningZDC = cms.vstring( 'HLT_L1ZDC_v1',
    'HLT_Physics_v8',
    'HLT_Random_v1' ),
  EcalLaser = cms.vstring( 'HLT_EcalCalibration_v4' ),
  ExpressCosmics = cms.vstring( 'HLT_Random_v1' ),
  HLTPhysics = cms.vstring( 'HLT_Physics_v8' ),
  L1Accept = cms.vstring( 'DST_Physics_v2' ),
  OnlineMonitor = cms.vstring( 'HLT_DQML1SeedsGroup1_v1',
    'HLT_L1FatEvents_v2',
    'HLT_Physics_v8' ),
...
process.GlobalTag = cms.ESSource( "PoolDBESSource",
    ...
    globaltag = cms.string( "132X_dataRun3_HLT_v2" ),
...
process.hltPreHIRawPrime = cms.EDFilter( "HLTPrescaler",
    offset = cms.uint32( 0 ),
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" )
)
...
process.hltPreL1ZDC = cms.EDFilter( "HLTPrescaler",
    offset = cms.uint32( 0 ),
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" )
)
process.hltPreDQML1SeedsGroup1 = cms.EDFilter( "HLTPrescaler",
    offset = cms.uint32( 0 ),
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" )
)
process.hltDQML1SeedsFilter = cms.EDFilter( "TriggerResultsFilter",
...
process.hltLumiMonitor = cms.EDProducer( "LumiMonitor",
    ...
    histoPSet = cms.PSet( 
      ...
      lumiPSet = cms.PSet( 
        xmin = cms.double( 0.0 ),
        nbins = cms.int32( 6000 ),
        xmax = cms.double( 30000.0 )
      ),
...
process.hltDatasetL1Accept = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1tIgnoreMaskAndPrescale = cms.bool( False ),
    throw = cms.bool( True ),
    triggerConditions = cms.vstring( 'DST_Physics_v2' )
)
...
process.hltDatasetCommissioningZDC = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1tIgnoreMaskAndPrescale = cms.bool( False ),
    throw = cms.bool( True ),
    triggerConditions = cms.vstring( 'HLT_L1ZDC_v1',
      'HLT_Physics_v8',
      'HLT_Random_v1' )
)
...
process.hltDatasetOnlineMonitor = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1tIgnoreMaskAndPrescale = cms.bool( False ),
    throw = cms.bool( True ),
    triggerConditions = cms.vstring( 'HLT_DQML1SeedsGroup1_v1 / 10',
      'HLT_L1FatEvents_v2',
      'HLT_Physics_v8 / 50' )
)
...
process.hltDatasetCommissioningRawPrime = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1tIgnoreMaskAndPrescale = cms.bool( False ),
    throw = cms.bool( True ),
    triggerConditions = cms.vstring( 'HLT_HIRawPrime_v1' )
)
...
process.hltOutputPhysics = cms.OutputModule( "PoolOutputModule",
    fileName = cms.untracked.string( "outputPhysics.root" ),
    compressionAlgorithm = cms.untracked.string( "ZSTD" ),
    compressionLevel = cms.untracked.int32( 3 ),
    fastCloning = cms.untracked.bool( False ),
    dataset = cms.untracked.PSet(
    ...
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'Dataset_CommissioningZDC',
  'Dataset_HLTPhysics' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep FEDRawDataCollection_rawDataCollector_*_*',
      'keep FEDRawDataCollection_source_*_*',
...
process.hltOutputRawPrime = cms.OutputModule( "PoolOutputModule",
    fileName = cms.untracked.string( "outputRawPrime.root" ),
    compressionAlgorithm = cms.untracked.string( "ZSTD" ),
    compressionLevel = cms.untracked.int32( 3 ),
    fastCloning = cms.untracked.bool( False ),
    dataset = cms.untracked.PSet(
...
process.HLTDoHIRawPrimeFromSiStripZS = cms.Sequence( process.hltSiStripDigiToZSRaw + process.hltSiStripClusterizerForRawPrime + process.hltSiStripClusters2ApproxClusters )
process.HLTDoHIStripZeroSuppressionAndRawPrime = cms.Sequence( process.HLTDoSiStripZeroSuppression + process.HLTDoHIRawPrimeFromSiStripZS )
...
process.HLT_HcalCalibration_v5 = cms.Path( process.HLTBeginSequenceCalibration + process.hltPreHcalCalibration + process.hltHcalCalibrationRaw + process.HLTEndSequence )
process.HLT_HIRawPrime_v1 = cms.Path( process.HLTBeginSequence + process.hltPreHIRawPrime + process.HLTDoHIStripZeroSuppressionAndRawPrime + process.rawDataRepacker + process.rawPrimeDataRepacker + process.HLTEndSequence )
process.HLT_L1FatEvents_v2 = cms.Path( process.HLTBeginSequenceL1Fat + process.hltPreL1FatEvents + process.HLTEndSequence )
process.HLT_L1ZDC_v1 = cms.Path( process.HLTBeginSequence + process.hltPreL1ZDC + process.HLTEndSequence )
process.HLT_DQML1SeedsGroup1_v1 = cms.Path( process.hltGtStage2Digis + process.hltPreDQML1SeedsGroup1 + process.hltDQML1SeedsFilter )
...
process.DQMHistograms = cms.EndPath( process.hltGtStage2Digis + process.hltOnlineMetaDataDigis + process.hltTriggerRatesMonitor + process.hltTriggerBxMonitor + process.hltLumiMonitor + process.hltPSColumnMonitor + process.hltOnlineBeamMonitor )
...
if 'GlobalTag' in process.__dict__:
    ...
    process.GlobalTag = customiseGlobalTag(process.GlobalTag, globaltag = '132X_dataRun3_HLT_v2')
